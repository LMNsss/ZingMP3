...
class AddFriendFragment : Fragment() {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        initiateView()
        addFriendBinding.btnContinue.setOnClickListener(){
            addFriendViewModel.count()
        }
        observe()
    }
    ...
    private fun observe(){
        addFriendViewModel.value.observe(viewLifecycleOwner, Observer {
            addFriendBinding.txtTitle.text = it.toString()
        })
    }
